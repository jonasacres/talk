Feature: @enumeration -> @constant
  ...
  Scenario Outline: Define a constant
    Given that I define a valid enumeration named <enumeration>
    And I define a constant named <constant> with value <value> and description <description>
    When I get the result hash
    Then the enumeration <enumeration> should contain a term named <constant>
  ...
  Scenario Outline: Define multiple constants
    ...
    When I get the result hash
    Then the enumeration <enumeration> should contain a term named <constant_1>
    ...
    And the enumeration <enumeration> should contain a term named <constant_2>
