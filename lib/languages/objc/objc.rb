...
def make_source
  ...
  master_files = [ "TalkClasses.h", "TalkClassesForward.h", "TalkConstants.h", "TalkObjectList.h", "TalkDefinition+Autogenerated.m.erb" ]
...
def talk_definition
  dict = { proto:prune_definition(@base[:proto]) }
end
